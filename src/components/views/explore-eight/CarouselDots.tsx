			...
			<div className="container">
				<div className="row mb--30">
					<div className="col-12">
						<h3 className="title">Explore Carousel Dots</h3>
					</div>
				</div>
				<div className="row">
					<div className="banner-one-slick slick-activation-07 slick-arrow-style-one rn-slick-dot-style slick-gutter-15">
